...
import org.hibernate.annotations.FetchMode;
  ...
  public Payment(Long paymentId, CourseOrder order, BigDecimal paymentValue,
  Date paymentDate, PaymentType type) { super(); this.paymentId = paymentId;
  this.order = order; this.paymentValue = paymentValue; this.paymentDate =
  paymentDate; this.type = type; }
  ...
  public void setPaymentValue(BigDecimal paymentValue) { this.paymentValue =
  paymentValue; }
  ...
  @Override
	public int hashCode() {
		...
		return super.hashCode() + this.getPaymentId().intValue();
	}
